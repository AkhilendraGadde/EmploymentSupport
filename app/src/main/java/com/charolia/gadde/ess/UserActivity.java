    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.open, R.string.close){
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                ...
                int width = findViewById(R.id.content_holder).getWidth();
                findViewById(R.id.content_holder).setTranslationX((width/1.75f) * slideOffset);
            }
        ...
        Snackbar.make(mDrawerLayout,"Hello, "+name+"! Welcome To ESS",Snackbar.LENGTH_SHORT).show();
    }
